    ...
    <section className="min-h-screen flex items-center justify-center pt-16 pb-32 overflow-hidden relative">
      ...
      >
        ...
        >
          ...
          >
            Med dagens tekniska utveckling vet vi att med rätt kompetens kan mycket 
            automatiseras. Vi tycker inte att man ska behöva betala för mycket för en 
            riktigt bra hemsida. Därför skapade vi Almfors – den personliga webbyrån 
            som gör det lilla extra till ett rimligt pris.
          </motion.p>
