...
const Footer = () => {
  ...
  return (
    <footer className="bg-muted py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-muted-foreground">
              Vi skapar moderna webbplatser och hanterar sociala medier som
              driver resultat.
            </p>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} Almfors. Alla rättigheter
              förbehållna.
            </p>

            {/* Länkar och cookie-inställningar */}
      ...
      {/* Dialog för cookie-inställningar */}
      <Dialog open={showSettings} onOpenChange={setShowSettings}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            <DialogTitle>Cookie-inställningar</DialogTitle>
            <DialogDescription>
              Hantera dina cookie-preferenser. Nödvändiga cookies kan inte
              stängas av eftersom de krävs för att webbplatsen ska fungera.
            </DialogDescription>
          </DialogHeader>
