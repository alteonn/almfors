    ...
    <section className="min-h-screen flex items-center justify-center pt-16 pb-32 overflow-hidden relative">
      ...
      >
        ...
        >
          ...
          >
            Skräddarsydd eller Squarespace?
          </motion.h1>
          
          <motion.p
            className="text-lg md:text-xl text-muted-foreground leading-relaxed"
          >
            Vi erbjuder både skräddarsydda webbplatser och Squarespace-lösningar. 
            Låt oss hjälpa dig välja den perfekta lösningen för ditt företag.
          </motion.p>
