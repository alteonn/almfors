    ...
    <section className="py-24 bg-gradient-to-b from-background to-muted/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          >
            Förutom våra standardpaket erbjuder vi skräddarsydda webbsidor för alla behov. 
            Oavsett om du behöver en komplex e-handelslösning, avancerade integrationer 
            eller unika funktioner, har vi kompetensen att leverera.
          </motion.p>
          ...
          >
            <Card className="relative overflow-hidden group hover-lift">
              ...
              <CardContent className="p-8 space-y-4">
                ...
                <p className="text-muted-foreground">
                  Vi använder tekniska språk och plattformar efter dina behov, inklusive 
                  Next.js, React, Vue.js, Node.js och fler. Vi är också experter på 
                  API-lösningar och affärssystemintegrationer.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="relative overflow-hidden group hover-lift">
              ...
              <CardContent className="p-8 space-y-4">
                ...
                <p className="text-muted-foreground">
                  Vi fokuserar på säkerhet, snabbhet och användarvänlighet för att skapa 
                  optimala lösningar som ger resultat för din verksamhet.
                </p>
              </CardContent>
            </Card>
          </motion.div>
...
export default WhyAlmforsServices;